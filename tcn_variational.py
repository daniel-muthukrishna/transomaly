"""
Adapted from the Python package keras-tcn to include Variational Inference.
Code taken from: https://github.com/philipperemy/keras-tcn/blob/master/tcn/tcn.py
which is an implementation of the Temporal Convolutional Network described in
